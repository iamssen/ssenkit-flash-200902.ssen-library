package ssen.component.input 
{
	...
	public class AbstInput extends SSenSprite 
	{
		...
		protected var _bg : ISkinObject;
		protected var _txt : InputTextField;
		...
		public function AbstInput(width : int, height : int, inputType : String = "all", frontMark : String = "", backMark : String = "")
		{
			...
			_txt = new InputTextField(createTextStyle(), createFontColors(), inputType, frontMark, backMark);
		...
		protected function createFontColors() : Dictionary
		{
			throw new AbstractMemberError();
		}
		protected function createBackGround() : ISkinObject
		{
			throw new AbstractMemberError();
		}
