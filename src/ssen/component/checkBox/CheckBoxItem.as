package ssen.component.checkBox 
{
	...
	public class CheckBoxItem extends SSenSprite implements ICheckBoxItem, IFontRenderObject
	{
		...
		private var _checkBox : ISkinObject;
		...
		public function CheckBoxItem(checkBox : ISkinObject, 
										width : int, 
										autoWidth : Boolean,
		...
		private function initializeArt(checkBox : ISkinObject, width : int, autoWidth : Boolean, textColors : Dictionary, textStyle : TextStyle, valign : String, fontRender : FontRender) : void
		{
		...
		public function get checkBox() : ISkinObject
		{
			return _checkBox;
		}
