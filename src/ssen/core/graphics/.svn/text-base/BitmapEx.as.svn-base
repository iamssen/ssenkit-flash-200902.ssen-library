package ssen.core.graphics 
{
	...
	public class BitmapEx 
	{
		 ...
		 */
		static public function drawGrid9Bitmap(source : BitmapData, scale9Grid : Rectangle, canvasWidth : int, canvasHeight : int, smoothing : Boolean = false) : BitmapData
		{
		 ...
		 * @author http://www.bytearray.org/?p=118 from ScaleBitmap 1.2.2
		 */
		static public function drawGrid3BitmapHorizontal(source : BitmapData, scale9Grid : Rectangle, canvasWidth : int, smoothing : Boolean = false) : BitmapData
		{
			var minWidth : int = source.width - scale9Grid.width;
			var isMinWidth : Boolean = canvasWidth <= minWidth;
			var width : int = (!isMinWidth) ? canvasWidth : minWidth;
		 ...
		 * @author http://www.bytearray.org/?p=118 from ScaleBitmap 1.2.2
		 */
		static public function drawGrid3BitmapVertical(source : BitmapData, scale9Grid : Rectangle, canvasHeight : int, smoothing : Boolean = false) : BitmapData
		{
			var minHeight : int = source.height - scale9Grid.height;
			var isMinHeight : Boolean = canvasHeight <= minHeight;
