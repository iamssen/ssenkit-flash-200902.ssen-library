...
{
	import bitmapDatas.ssenProfile;
	...
	public class DrawTrianglesExample extends Example 
	{
		...
		private function addedToStage(event : Event) : void
		{
			...
			// bitmapData
			var bmd : BitmapData = new ssenProfile(0, 0);
			...
			// 개인적으로 만든 라이브러리
			var ds : DistortShape = new DistortShape(new Point(0, 0), new Point(80, 20), new Point(0, 100), new Point(80, 80), new ssenProfile(0, 0));
			ds.x = 10;
			ds.y = 150;
